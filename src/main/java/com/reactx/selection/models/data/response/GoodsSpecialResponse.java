...
import com.reactx.selection.models.data.index.HDKGoodsSpecial;
...
@Data
@ApiModel("好单库朋友圈API")
public class GoodsSpecialResponse implements Serializable {
    ...
    private List<HDKGoodsSpecial> data;
