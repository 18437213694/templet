...
import com.reactx.selection.models.data.index.HDKSingleBrand;
...
@Data
@ApiModel("单个品牌详情")
public class HDKBrandInforResponse implements Serializable {
    ...
    private List<HDKSingleBrand> data;
}
