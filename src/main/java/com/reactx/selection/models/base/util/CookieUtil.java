...
public class CookieUtil {
    ...
    public static final int COOKIE_MAX_AGE = 100*365*24*60*60;
    ...
    public static void addCookie(String phone, HttpServletResponse response, HttpServletRequest request){
        if(StringUtils.isNotBlank(phone)){
            //创建cookie  
            Cookie cookie = new Cookie("phone", phone);
            cookie.setPath(request.getContextPath()+"/");//设置cookie路径  
            //设置cookie保存的时间 单位：秒  (COOKIE_MAX_AGE)---保存时间为一百年
